...
class MenuListController extends Controller
{
    ...
    public function getTasted(Request $request)
    {
        $menu_lists = $this->menuListRepository->getTasted($request);
    ...
    {
        $menu_lists = $this->menuListRepository->getPromotionsNearby($request, $request->currentPosition);
//        return $menu_lists;
        $response = $this->response->collection($menu_lists, new MenuListTransformer($this->menuListRepository));
        return $response;
    }
