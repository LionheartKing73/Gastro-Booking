...
<body bgcolor="#FFFFFF" lang=CSlink=#000080 vlink=#800080 text="#000000">
	...
	<p>
		<?php echo ($order->pick_up === 'Y') ? "PICK UP" : (($order->delivery_address && $order->delivery_phone) ? "DELIVERY" : "BOOKING"); ?> <?= $order->cancellation  ?>  <?= $user->name ?> <?= $client_number ?> <?= $order->delivery_address; ?><br/>
