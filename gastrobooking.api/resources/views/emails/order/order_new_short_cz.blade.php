...
<p>
		<?php echo ($order->pick_up === 'Y') ? "VYZVEDNUTÍ" : (($order->delivery_address && $order->delivery_phone) ? "DOVOZ" : "REZERVACE"); ?> <?= $order->cancellation  ?>  <?= $user->name ?> <?= $client_number ?> <?= $order->delivery_address; ?><br/>
